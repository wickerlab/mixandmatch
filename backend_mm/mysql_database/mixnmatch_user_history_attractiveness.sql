...
CREATE TABLE `user_history_attractiveness` (
  ...
  `received_accept` int(10) unsigned zerofill DEFAULT NULL,
  `received_reject` int(10) unsigned zerofill DEFAULT NULL,
  PRIMARY KEY (`user_id`),
  CONSTRAINT `attractiveness_user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
